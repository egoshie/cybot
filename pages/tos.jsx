...
<p>⊳ Every discord server can use the cybot bot for free, it is completely prohibited to sell or market for a fee.</p>
...
<div className="py-3"></div>
<p>⊳ To use certain discord bot commands, you need to vote for the <a className="text-white" href="https://discord.com/oauth2/authorize?client_id=1233521387142905896">cybot</a> bot at certain intervals.</p>
</div>
    </div>
  );
}
